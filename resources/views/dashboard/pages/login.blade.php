            ...
            <div class="card-body login-card-body">
                ...
                <form action="{{ route('dashboard.login') }}" method="post">
                    ...
                    <div class="input-group mb-3">
                        <input type="email" name="email" @class(['form-control', 'is-invalid' => $errors->has('email')]) placeholder="Email">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" @class(['form-control', 'is-invalid' => $errors->has('password')]) placeholder="Password">
                        <div class="input-group-append">
                            <div class="input-group-text">
